...
label start:
    ...
    p "Так, курсач сам себя не напишет, а шортсы сами себя не полайкают. О, письмо пришло. От Федбанка? Интересно, неужели мне пришли 15 рублей кэшбэка от покупки холодтльника в Эльдавидео?"
